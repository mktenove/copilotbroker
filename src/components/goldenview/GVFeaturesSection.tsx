...
import { Mountain, Sun, TreePine, ShieldCheck, TrendingUp, Check } from "lucide-react";
import clubRender from "@/assets/goldenview/club-render.png";

const features = [
  { icon: Mountain, text: "Vista panorâmica real, em localização elevada" },
  { icon: Sun, text: "Lotes com altíssima incidência solar" },
  { icon: TreePine, text: "Arquitetura orgânica, integrada ao relevo natural" },
  { icon: ShieldCheck, text: "Condomínio fechado, com segurança e infraestrutura completa" },
  { icon: TrendingUp, text: "Projeto pensado para valorização patrimonial desde o primeiro dia" }
];

const GVFeaturesSection = () => {
      ...
      <div className="container px-4 relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            ...
            <span className="text-gold-gradient">QUERER COMPRAR AQUI</span>
          </h2>
          <p className="text-lg text-muted-foreground">
            Porque o Residencial GoldenView entrega tudo o que hoje é raro:
          </p>
        </div>
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            <div className="pt-4">
              <p className="font-serif text-lg md:text-xl italic text-muted-foreground">
                Aqui, cada detalhe foi planejado para gerar{" "}
                <span className="text-primary font-semibold">desejo</span>,{" "}
                <span className="text-primary font-semibold">conforto</span> e{" "}
                <span className="text-primary font-semibold">valorização</span>.
              </p>
            </div>
          </div>
          ...
          >
            <div className="relative rounded-lg overflow-hidden shadow-elegant">
              ...
              {imageLoaded && (
                <img
                  src={clubRender}
                  alt="Infraestrutura do GoldenView"
...
export default GVFeaturesSection;
