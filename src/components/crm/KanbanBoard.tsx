...
const STATUSES: LeadStatus[] = ['new', 'info_sent', 'copiloto', 'scheduling', 'docs_received', 'registered'];
const STATUS_ORDER: LeadStatus[] = ['new', 'info_sent', 'copiloto', 'scheduling', 'docs_received', 'registered'];
