    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 bg-background border-b border-border">
        <div className="container py-4 flex items-center justify-between">
          <Link 
            to="/portao/goldenview#cadastro" 
            className="inline-flex items-center gap-2 text-foreground/70 hover:text-foreground transition-colors text-sm min-h-[44px] px-2"
          >
      ...
      <main className="container py-8 md:py-12 lg:py-20">
        <div className="max-w-3xl mx-auto space-y-12 md:space-y-16">
          ...
          <section id="politica-de-privacidade">
            ...
            <div className="space-y-6 md:space-y-8 text-muted-foreground text-sm sm:text-base">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 ml-2 md:ml-4">
                  <li>Entrar em contato com o titular para envio de informações sobre o empreendimento GoldenView Residencial em Portão;</li>
          ...
          <section id="termos-de-uso">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-serif text-foreground mb-2 md:mb-4">
              Termos de Uso
            </h1>
            <p className="text-muted-foreground text-sm mb-6 md:mb-8">
              Formulário de Divulgação – GoldenView Residencial, Portão/RS
            </p>
            ...
            <div className="space-y-6 md:space-y-8 text-muted-foreground text-sm sm:text-base">
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 ml-2 md:ml-4">
                  <li>Receber informações preliminares e comerciais sobre o empreendimento GoldenView Residencial, localizado em Portão/RS;</li>
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-medium text-foreground mb-2 md:mb-3">4. Caráter ilustrativo do material apresentado</h2>
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-medium text-foreground mb-2 md:mb-3">6. Limitação de responsabilidade</h2>
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-medium text-foreground mb-2 md:mb-3">7. Foro</h2>
                <p className="leading-relaxed">
                  Fica eleito o foro da comarca de <strong className="text-foreground">Portão/RS</strong>, com renúncia a qualquer outro, 
          ...
          <div className="text-center pt-4 md:pt-8">
            <Link 
              to="/portao/goldenview#cadastro" 
              className="inline-flex items-center gap-2 px-6 md:px-8 py-3 md:py-4 bg-primary text-primary-foreground font-medium uppercase tracking-[0.15em] text-xs hover:bg-primary/90 transition-colors min-h-[48px]"
            >
              <ArrowLeft className="w-4 h-4" />
              Voltar ao cadastro
            </Link>
...
export default TermosGoldenView;
