...
const Prontos = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Imóveis Prontos para Morar — Vale dos Sinos | Enove</title>
        <meta
          name="description"
          content="Encontre seu imóvel pronto para morar no Vale dos Sinos. Sem espera, sem obra. Cadastre-se e receba as melhores oportunidades."
        />
        <link rel="canonical" href="https://onovocondominio.com.br/prontos" />
        <meta property="og:title" content="Imóveis Prontos para Morar | Enove" />
        <meta
          property="og:description"
          content="Encontre seu imóvel pronto para morar no Vale dos Sinos. Sem espera, sem obra."
        />
        <meta property="og:url" content="https://onovocondominio.com.br/prontos" />
        ...
        <main className="flex-1 flex flex-col items-center justify-center px-4 py-8 md:py-12">
          <div ref={heroRef} className="max-w-2xl mx-auto text-center space-y-6">
            ...
            <div className={itemClass(1)}>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif font-bold tracking-tight text-foreground/90">
                Seu Imóvel Pronto
                <br />
                <span className="text-primary">Para Morar</span>
              </h1>
            </div>
            ...
            <div className={itemClass(3)}>
              <p className="text-base sm:text-lg text-muted-foreground max-w-md mx-auto leading-relaxed font-light tracking-wide">
                Sem espera, sem obra. Encontre as melhores oportunidades de imóveis prontos no Vale dos Sinos com a curadoria da Enove.
              </p>
            </div>
