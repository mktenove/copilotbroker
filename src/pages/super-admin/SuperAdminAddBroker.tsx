  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const tenantStatus = form.creation_type === "self_serve" ? "pending_payment" : 
                           form.initial_status === "trialing" ? "trialing" : 
                           form.initial_status === "pending_invite" ? "active" : "active";
      ...
      await (supabase.from("audit_logs" as any).insert({
        ...
        after_data: { name: form.name, email: form.email, creation_type: form.creation_type, initial_status: form.initial_status },
      }) as any);
        ...
        <div className="max-w-3xl mx-auto px-4 py-6">
          {checkoutUrl ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Status inicial (apenas para manual/migrate) */}
              ...
              <Card className="bg-[#1e1e22] border-[#2a2a2e]">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-2">
                    ...
                    <label htmlFor="send_invite" className="text-sm text-white cursor-pointer">Enviar convite agora</label>
                  </div>
                  {form.send_invite && (
                    <div className="space-y-2">
