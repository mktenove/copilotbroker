        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
            {[
              ...
              <Card key={k.label} className={cn("bg-[#1e1e22] border-[#2a2a2e] cursor-pointer hover:border-[#3a3a3e] transition-all", statusFilter === k.filter && "ring-1 ring-[#FFFF00]/30")} onClick={() => k.filter && setStatusFilter(k.filter)}>
