    ...
    Tables: {
      ...
      auto_cadencia_steps: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "auto_cadencia_steps_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      broker_activity_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "broker_activity_logs_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      broker_auto_cadencia_rules: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "broker_auto_cadencia_rules_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      broker_auto_message_rules: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "broker_auto_message_rules_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      broker_projects: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "broker_projects_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      broker_sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "broker_sessions_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      broker_whatsapp_instances: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "broker_whatsapp_instances_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      copilot_configs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "copilot_configs_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      lead_attribution: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "lead_attribution_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      proposta_parcelas: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "proposta_parcelas_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      roletas: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "roletas_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      roletas_empreendimentos: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "roletas_empreendimentos_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      roletas_log: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "roletas_log_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      roletas_membros: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "roletas_membros_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
